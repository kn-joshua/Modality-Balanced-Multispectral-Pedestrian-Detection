...
def kaist_eval():
    ...
    #     raise ValueError("Visible and thermal image folders do not have the same number of images.")

    fps = 60
    frame_delay = int(1000 / fps)

    # Loop through corresponding images
    for rgb_image_name, thermal_image_name in zip(rgb_images, thermal_images):
    ...
    with open(csv_file, mode='a', newline='') as file:
        ...
        writer.writerow({"dataset": "kaist_full", "fppi": "10^-2", "miss rate": miss_rate})
